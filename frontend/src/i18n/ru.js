export const ru = {
  ...
  stats: {
    ...
    insights: {
      ...
      tag_lower: 'Записи с тегом «{tag}» в среднем на {diff} ниже общего среднего',
      tag_higher: 'Записи с тегом «{tag}» в среднем на {diff} выше общего среднего',
      daysPlural: {
        1: 'понедельникам',
        2: 'вторникам',
        3: 'средам',
  ...
  auth: {
    ...
    resetTokenInvalid: 'Ссылка для сброса пароля недействительна или отсутствует токен.',
    requestNewLink: 'Запросить новую ссылку',
    saveNewPassword: 'Сохранить новый пароль',
    passwordResetSuccess: 'Пароль успешно изменён. Пожалуйста, войдите с новым паролем.',
  },
  ...
  confirmDelete: {
    ...
    invalidToken: 'Ссылка на удаление аккаунта недействительна или отсутствует токен.',
    backToLogin: 'Вернуться к входу',
    areYouSure: 'Вы абсолютно уверены?',
    warningDetails: 'Удаление вашего аккаунта анонимизирует ваш профиль, скроет все ваши записи в дневнике и удалит все связи с друзьями в Moodila.',
    confirmBtn: 'Удалить аккаунт навсегда',
    deleting: 'Удаление аккаунта…',
    cancelBtn: 'Отменить и сохранить аккаунт',
    successMessage: 'Ваш аккаунт Moodila был успешно удалён.',
    errorMessage: 'Не удалось подтвердить удаление аккаунта. Ссылка может быть недействительна или устарела.',
  },
  ...
  admin: {
    ...
    accessDeniedDesc: 'У вас нет прав администратора для просмотра этой страницы.',
    ...
    deleteConfirmDesc: 'Вы уверены, что хотите безвозвратно удалить это объявление? Это действие нельзя отменить.',
    readsCount: 'Прочли',
    ...
    statsNoInteractions: 'Пока никто из пользователей не взаимодействовал с этим объявлением.',
