export const en = {
  ...
  stats: {
    title: "Your Rhythms",
    subtitle: "Patterns and reflections of your mood",
    periods: {
      week: "Week",
      month: "Month",
      year: "Year",
    ...
    insightsHeader: "Observations",
    insightsTitle: "Patterns & Observations",
    insights: {
    ...
    dayOfWeekPattern: "Weekly Rhythm",
    tagCorrelation: "Tag Influence & Context",
    moodDistribution: "Mood Balance",
    annualHeatmap: "Annual Canvas",
    heatmapLegend: "Mood Spectrum",
    less: "Awful",
    more: "Rad",
    spectrumAwful: "Awful",
    spectrumRad: "Rad",
    noData: "No entries logged for this period yet",
    insufficientData: "More tagged entries needed to highlight correlations",
    minTagDataNote: "Highlighted tags have at least 3 entries",
    lowestMoodTag: "Challenging factor",
    highestMoodTag: "Uplifting factor",
