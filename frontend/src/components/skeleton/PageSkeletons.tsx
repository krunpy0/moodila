...
export function HomeSkeleton() {
  return <div className="space-y-lg" role="status" aria-label="Loading your journal">
    <section className="rounded-2xl bg-surface-container-lowest p-lg shadow-card border border-outline-variant/15"><Skeleton width="58%" height="2rem" /><Skeleton className="mt-md" width="9.5rem" height="2.5rem" borderRadius="9999px" /></section>
    <section className="space-y-md"><div className="flex justify-between"><Skeleton width="8rem" height="1rem" /><Skeleton width="3.5rem" height="0.875rem" /></div><div className="flex justify-between gap-sm overflow-x-auto rounded-xl lg:rounded-xxl bg-surface-container-lowest p-md lg:p-6 shadow-card border border-outline-variant/15">{Array.from({ length: 7 }, (_, i) => <div key={i} className="flex flex-col items-center gap-xs"><SkeletonCircle size="3rem" /><Skeleton width="1.75rem" height="0.75rem" /></div>)}</div></section>
    <section className="grid grid-cols-2 gap-md"><div className="col-span-2 rounded-2xl bg-surface-container-lowest p-lg shadow-card border border-outline-variant/15"><Skeleton width="9rem" height="1.75rem" /><Skeleton className="mt-sm" width="5rem" height="2.5rem" /><Skeleton className="mt-xs" width="13rem" height="0.875rem" /></div>{Array.from({ length: 2 }, (_, i) => <div key={i} className="min-h-[140px] rounded-2xl bg-surface-container-lowest p-lg shadow-card border border-outline-variant/15"><Skeleton width="70%" height="0.75rem" /><Skeleton className="mt-auto translate-y-14" width="80%" height="1.75rem" /></div>)}</section>
