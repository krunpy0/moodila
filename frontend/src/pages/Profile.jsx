  ...
  return <main className="mx-auto min-h-screen w-full max-w-md bg-background pb-32 text-on-background">
    ...
    <div className="px-container-margin pt-sm">
      ...
      {user && <>
        ...
        <section className="rounded-[24px] bg-surface-container-lowest p-lg cloud-shadow"><h2 className="mb-md text-label-lg text-on-surface-variant">App settings</h2><div className="flex items-center justify-between border-t border-surface-container-low py-sm"><span className="flex items-center gap-sm text-body-md text-on-surface"><span className="material-symbols-outlined text-on-surface-variant">palette</span>Dark theme</span><ThemeToggle /></div><div className="border-t border-surface-container-low pt-xs"><button type="button" onClick={() => setShowChangePassword((prev) => !prev)} className="flex w-full items-center justify-between py-sm text-left text-body-md font-medium text-on-surface"><span className="flex items-center gap-sm"><span className="material-symbols-outlined text-on-surface-variant">lock</span>Change password</span><span className="material-symbols-outlined text-on-surface-variant">{showChangePassword ? 'expand_less' : 'expand_more'}</span></button>{showChangePassword && <ChangePasswordForm />}</div><div className="border-t border-surface-container-low pt-xs"><button type="button" onClick={() => setShowDeleteModal(true)} className="flex w-full items-center justify-between py-sm text-left text-body-md font-medium text-error transition-opacity hover:opacity-80"><span className="flex items-center gap-sm"><span className="material-symbols-outlined text-error">delete_forever</span>Delete account</span><span className="material-symbols-outlined text-on-surface-variant text-[20px]">chevron_right</span></button></div></section>
